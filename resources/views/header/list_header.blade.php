    ...
    <div class="container-custom">
        ...
        <div class="p-4 bg-light rounded shadow">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List Headers</h4>

                <div class="d-flex flex-column align-items-start align-items-md-end gap-2">
                    <a href="{{ route('add_header') }}" class="btn-add">
                        Add Header
                    </a>
                    <a href="{{ route('list_deleted_headers') }}" class="btn-link">
                        Show Deleted Headers
                    </a>
                </div>
            </div>
                    ...
                    <table class="table table-hover align-middle custom-table" id="members-table">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <a href="#" class="sort-link" data-column="sequence_no">
                                        Sequence
                                        <span class="sort-icons">
                                            <i class="asc">▲</i>
                                            <i class="desc">▼</i>
...
@push('scripts')
<script>
    const fetchHeadersUrl = "{{ route('fetch_headers') }}";
    const deleteHeaderUrl = "{{ route('delete_header', ':id') }}";
</script>

<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/header/list_header.js') }}"></script>
@endpush
