...
<form id="gym_member_add_form" class="p-4 bg-light rounded shadow" 
    ...
    <div class="row g-3">
        <div class="col-md-12 col-12">
            <label class="form-label">{{ __('membership.name_label') }}</label>
    ...
    <div class="row g-3 mt-2">
        <div class="col-12">
            <label class="form-label">{{ __('membership.description_label') }}</label>
    ...
    <div class="row g-3 mt-2">
        <div class="col-md-6 col-12">
            <label class="form-label">{{ __('membership.duration_label') }}</label>
        ...
        <div class="col-md-6 col-12">
            <label class="form-label">{{ __('membership.price_label') }}</label>
    ...
    <div class="row g-3 mt-2">
        <div class="col-md-6 col-12">
            <label class="form-label">{{ __('membership.trainer_label') }}</label>
    ...
    <div class="row g-3 mt-2">
        <div class="col-md-6 col-12">
            <label class="form-label">{{ __('membership.active_label') }}</label>
