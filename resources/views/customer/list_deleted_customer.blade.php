...
@section('title', 'Deleted Customer List')
    ...
    <div class="container-custom">
        ...
        <div class="p-4 bg-light rounded shadow">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List Deleted Customers</h4>
            </div>
...
@push('scripts')
<script>
    const fetchDeletedCustomersUrl = "{{ route('fetch_deleted_customers') }}";
    const activateCustomerUrl = "{{ route('activate_customer', ':id') }}";
</script>

<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/customer/list_deleted_customer.js') }}"></script>
@endpush
