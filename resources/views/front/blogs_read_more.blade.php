        ...
        <div class="blog-card mt-3">
            <div class="back-btn">
                ...
                <a href="javascript:void(0);" onclick="history.back()" class="btn-read">
                    <i class="bi bi-arrow-left fs-5 ms-1 align-middle"></i>Back
                </a>
            </div>

            <img src="https://images.unsplash.com/photo-1558611848-73f7eb4001a1?w=600" class="blog-image mt-2" alt="Gym">
            <div class="blog-content mt-2s">
                <h2 class="blog-title py-2">Our Latest Blog</h2>
                <p class="blog-description mt-2 mb-5">
