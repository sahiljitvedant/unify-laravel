...
@section('title', 'Members Deleted List')
    ...
    <div class="container-custom">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">List Deleted Members</li>
            </ol>
        </nav>
        <div class="p-4 bg-light rounded shadow">
            <!-- Heading + Add Button -->
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List Deleted Members</h4>
...
@push('scripts')
<script>
    const fetchDeletedMemberList = "{{ route('fetch_deleted_member_list') }}";
    const activateMembershipUrl = "{{ route('activate_member', ':id') }}";
</script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/gym_package/list_deleted_member.js') }}"></script>
