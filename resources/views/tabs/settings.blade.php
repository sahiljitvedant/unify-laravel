    ...
    <div class="step" data-step="3">
        <div class="row g-3">
            ...
            <div class="col-md-6 col-12">
                ...
                <select class="form-control" name="preferred_workout_time" id="preferred_workout_time" disabled>
        ...
        <div class="row g-3 mt-2">
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="number" class="form-control" 
                       ...
                       value="{{ old('current_weight', $member->current_weight ?? '') }}" disabled>
        ...
        <div class="row g-3 mt-2">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" 
                          ...
                          rows="3" disabled>{{ old('additional_notes', $member->additional_notes ?? '') }} </textarea>
                <div class="text-danger error-message" data-error-for="additional_notes"></div>
            </div>
        </div>
    </div>
    <!-- <div class="text-end mt-4">
        <button type="submit" class="btn btn-primary" id="profiesubmitBtn">Submit</button>
    </div> -->
</form>
