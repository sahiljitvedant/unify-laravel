...
@section('title', 'Replied Enquiry List')
    ...
    <div class="container-custom">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">List Replied Enquiry</li>
            </ol>
        </nav>
        <div class="p-4 bg-light rounded shadow">
            <!-- Heading + Add Button -->
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List Replied Enquiry</h4>
                <!-- <a href="{{ route('list_deleted_membership') }}" class="btn-link">Show Replied Enquiry</a> -->
                    ...
                    <table class="table table-hover align-middle custom-table" id="members-table">
                        <thead >
                            <tr>
                                ...
                                <th>Message</th>
                                <th>
                                    <a href="#" class="sort-link" data-column="our_reply">
                                        Our Reply
...
@push('scripts')
<script>
    const fetchEnquiry = "{{ route('fetch_replied_enquiry') }}";
</script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/enquiry/list_replied_enquiry.js') }}"></script>
