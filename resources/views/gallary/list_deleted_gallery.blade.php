...
@section('title', 'Deleted Gallary List')
    ...
    <div class="container-custom">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">List Deleted Gallery</li>
            </ol>
        </nav>
        <div class="p-4 bg-light rounded shadow">
            <!-- Heading + Add Button -->
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List Deleted Gallery</h4>
...
@push('scripts')
<script>
    const fetchDeletedGallery = "{{ route('fetch_list_deleted_gallery') }}";
    const activateGallery = "{{ route('activate_gallary', ':id') }}";
</script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/gallary/list_deleted_gallery.js') }}"></script>
@endpush
