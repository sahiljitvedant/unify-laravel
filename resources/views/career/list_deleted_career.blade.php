...
@section('title', 'Deleted Career List')
    ...
    <div class="container-custom">
        ...
        <div class="p-4 bg-light rounded shadow">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List Deleted Careers</h4>
            </div>
...
@push('scripts')
<script>
    const fetchDeletedCareers = "{{ route('fetch_deleted_careers') }}";
    const activateCareer = "{{ route('activate_career', ':id') }}";
</script>

<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/career/list_deleted_career.js') }}"></script>
@endpush
