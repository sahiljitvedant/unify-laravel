    ...
    <div class="container-custom">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">List FAQ's</li>
            </ol>
        </nav>
        <div class="p-4 bg-light rounded shadow">
            <!-- Heading + Add Button -->
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List FAQ's</h4>
                <div class="d-flex flex-column align-items-start align-items-md-end gap-2">
                    <a href="{{ route('add_faq') }}" class="btn-add">Add FAQS</a>
                    <a href="{{ route('list_deleted_faqs') }}" class="btn-link">Show Deleted FAQ</a>
                </div>
            </div>
...
@push('scripts')
<script>
    const fetchMembership = "{{ route('fetch_faqs') }}";
    const deleteMembershipUrl = "{{ route('delete_faqs', ':id') }}";
</script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/faqs/list_faqs.js') }}"></script>
@endpush
