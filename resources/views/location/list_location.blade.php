    ...
    <div class="container-custom">
        ...
        <div class="p-4 bg-light rounded shadow">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List Locations</h4>

                <div class="d-flex flex-column align-items-start align-items-md-end gap-2">
                    <a href="{{ route('add_location') }}" class="btn-add">
                        Add Location
                    </a>
                    <a href="{{ route('list_deleted_locations') }}" class="btn-link">
...
@push('scripts')
<script>
    const fetchLocationsUrl = "{{ route('fetch_locations') }}";
    const deleteLocationUrl = "{{ route('delete_location', ':id') }}";
</script>

<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/location/list_location.js') }}"></script>
@endpush
