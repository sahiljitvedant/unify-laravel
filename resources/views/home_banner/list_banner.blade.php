    ...
    <div class="container-custom">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">List Banner</li>
            </ol>
        </nav>
        <div class="p-4 bg-light rounded shadow">
            <!-- Heading + Add Button -->
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
                <h4 class="mb-2 mb-md-0">List Banner</h4>
                <div class="d-flex flex-column align-items-start align-items-md-end gap-2">
                    <a href="{{ route('home_banner_add') }}" class="btn-add">Add Banners</a>
                    <a href="{{ route('list_deleted_banner') }}" class="btn-link">Show Deleted Banner</a>
                </div>
            </div>
...
@push('scripts')
<script>
    const fetchMembership = "{{ route('fetch_home_banner') }}";
    const deleteMembershipUrl = "{{ route('delete_home_banner', ':id') }}";
</script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="{{ asset('assets/js/home_banner/list_banners.js') }}"></script>
